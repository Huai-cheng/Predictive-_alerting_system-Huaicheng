...
PLOT_OUTPUT_PATH = "notebooks/results_visualization_synthetic.png"

W = 288
H = 12

def main():
    print("=== Predictive Alerting Visualization (Synthetic Data) ===")
    ...
    try:
        ...
        print(f"Model artifact not found. Please run 'python jobs/retrain_synthetic.py' first.")
        sys.exit(1)
