...
PLOT_OUTPUT_PATH = "notebooks/results_visualization_ec2.png"

W = 288
H = 12

def main():
    print("=== Predictive Alerting Visualization (AWS EC2) ===")
    ...
    try:
        ...
        print(f"Model artifact not found. Please run 'python jobs/retrain_ec2.py' first.")
        sys.exit(1)
